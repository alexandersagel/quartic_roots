...
static PyObject * quarticRoots(PyObject *self, PyObject *args)
{
    double a; double b; double c; double d; double e;
    if (!PyArg_ParseTuple(args, "ddddd", &a, &b, &c, &d, &e)) {
        return NULL;
    }
...
static PyMethodDef quarticMethods[] = {
    {"quartic_roots", quarticRoots, METH_VARARGS, "Computing zeros of a quartic plynomial"},
    {NULL, NULL, 0, NULL}
};

static struct PyModuleDef quarticmodule = {
...
PyMODINIT_FUNC PyInit_quartic_c(void)
{
    return PyModule_Create(&quarticmodule);
}
